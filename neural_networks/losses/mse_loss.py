...
class MSELoss(Loss):
    def __init__(self) -> None:
        ...
        Attributes:
            _y_true (Optional[ARRAY_TYPE]): Ground truth values, stored during forward pass.
            _y_pred (Optional[ARRAY_TYPE]): Predicted values, stored during forward pass.
            _size (Optional[int]): Total number of elements, used for averaging the loss.
        """
        super().__init__()
    ...
    def backprop(self) -> ARRAY_TYPE:
        ...
        Returns:
            ARRAY_TYPE: Gradient of the MSE loss with respect to \( y_{pred} \).
        """
